            ...
            if keys[pygame.K_SPACE]:
                ...
                if shooter_count == self.shoot_speed:
                    if self.rect.x > -1000:
                        ...
                        bulletlist_left.add(Bullet(self, 0))
                    shooter_count = 0
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, shooter, kind):
        ...
        self.image1 = pygame.image.load("images/冰豆.gif").convert_alpha()
...
class ZombieManager(pygame.sprite.Sprite):
    ...
    def gen_new_rugby_zombie(self, gen):
        self.zombie_list.append(Rugby_Zombie(1000, gen))

    def gen_new_flag_zombie(self, gen):
        self.zombie_list.append(Flag_Zombie(1000, gen))
...
class Rugby_Zombie(pygame.sprite.Sprite):
    ...
    def draw(self, camera):
        ...
        if self.style == 0:  # 正常移动
            ...
            self.rect.x = self.x
            self.rect.y = screen_height - (self.y + rugby_frame0[self.snow][walkblit].get_height())
            screen.blit(
                rugby_frame0[self.snow][walkblit],
                (
                    self.rect.x - camera[0]+(160-rugby_frame0[self.snow][walkblit].get_width()),
                    self.rect.y - camera[1],
                    self.rect.width,
                    self.rect.height,
                ),
            ...
            if self.HP > 500 and not self.eating:
                ...
                if self.n < 3:
                    ...
                    screen.blit(
                        changecolor(story, 1.6, 1.6, 1.6),
                        (
                            self.rect.x - camera[0]+(160-rugbynocap_frame0[self.snow][walkblit].get_width()),
                            self.rect.y - camera[1],
                            self.rect.width,
                            self.rect.height,
                        ),
                ...
                if self.n < 3:
                    ...
                    screen.blit(
                        changecolor(story, 1.6, 1.6, 1.6),
                        (
                            self.rect.x - camera[0]+(160-rugbynohead_frame0[self.snow][walkblit].get_width()),
                            self.rect.y - camera[1],
                            self.rect.width,
                            self.rect.height,
                        ),
                ...
                if self.n < 3:
                    ...
                    screen.blit(
                        changecolor(story, 1.6, 1.6, 1.6),
                        (
                            self.rect.x - camera[0]+(160-rugbyeat_frame0[self.snow][eatblit].get_width()),
                            self.rect.y - camera[1],
                            self.rect.width,
                            self.rect.height,
                        ),
                ...
                if self.n < 3:
                    ...
                    screen.blit(
                        changecolor(story, 1.6, 1.6, 1.6),
                        (
                            self.rect.x - camera[0]+(160-rugbynocapeat_frame0[self.snow][nocapeatblit].get_width()),
                            self.rect.y - camera[1],
                            self.rect.width,
                            self.rect.height,
                        ),
                ...
                if self.n < 3:
                    ...
                    screen.blit(
                        changecolor(story, 1.6, 1.6, 1.6),
                        (
                            self.rect.x - camera[0]+(160-rugbynoheadeat_frame0[self.snow][noheadeatblit].get_width()),
                            self.rect.y - camera[1],
                            self.rect.width,
                            self.rect.height,
                        ),
            ...
            elif self.HP > 120 and self.HP <= 500:
                screen.blit(
                    self.image2, (self.rect.x - camera[0], self.rect.y - camera[1])
                )
        elif self.style == 7:  # 无头行走
            ...
            for planr in plant_list:
                if pygame.Rect(
                    self.rect.x - camera[0]+(160-rugbynohead_frame0[self.snow][0].get_width()),
                    self.rect.y - camera[1],
                    self.rect.width,
                    self.rect.height,
            ...
            if self.HP > 500 and not self.hit:
                ...
                if not pygame.Rect(
                    player.rect.x - camera[0]+(80-rugbyeat_frame0[self.snow][eatblit].get_width()),
                ...
                screen.blit(
                    ...
                    (self.rect.x - camera[0]+(160-rugbynocapeat_frame0[self.snow][eatblit].get_width()), self.rect.y - camera[1]),
                )
                if not pygame.Rect(
                    player.rect.x - camera[0]+(80-rugbynocapeat_frame0[self.snow][eatblit].get_width()),
                    player.rect.y - camera[1] - (player.rect.width - 65),
                    player.rect.width,
                    player.rect.height,
                ).colliderect(
                    pygame.Rect(
                        self.rect.x - camera[0]+(160-rugbynocapeat_frame0[self.snow][eatblit].get_width()),
                        self.rect.y - camera[1],
                        self.rect.width//2,
                        self.rect.height//2,
                    )
...
class Flag_Zombie(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.noheadeatindex = 0
        self.moneyindex = 0
        self.image = pygame.image.load("images/旗帜僵尸/旗帜僵尸图层-1.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y
        self.n = 0
    ...
    def draw(self, camera):
        ...
        if self.style == 0:  # 正常移动
            ...
            self.walkindex += 0.1 / (self.snow + 1)
            walkblit = int(self.walkindex % len(flag_frame0[self.snow]))
            self.y = screen_height - (self.y + flag_frame0[self.snow][walkblit].get_height())
            screen.blit(
                flag_frame0[self.snow][walkblit], (self.x - camera[0], self.y - camera[1])
            )
        elif self.style == 6:  # 失败未进家但吃完脑子
            if self.dealing == 0:
                self.image = changecolor(self.image, 0.5, 0.5, 0.5)
