            ...
            for winindex in range(1,202):
                ...
                if winindex >= 1 and winindex <= 400:
                    ...
                    if winindex == 1:
                        pass  # 这里放胜利的音效
                    if winindex <= 100:
                        wincupp = pygame.transform.scale(wincupp,(166 + winindex, 136 + 0.82*winindex))
                        screen.blit(wincupp,(700 - 3.5*winindex, 350 - 2.5*winindex))
                    else:
                ...
                if moneyindex < 15:
                    ...
                    diamond1 = Fallthing(money_frame[moneyblit],
                        600 - h(moneyindex - 15, 600 - 30),
                        280 + h(moneyindex - 15, 630 - 280),
                        40,40)
                    diamond2 = Fallthing(money_frame[moneyblit],
                        700 - h(moneyindex - 15, 700 - 30),
                        280 + h(moneyindex - 15, 630 - 280),
                        40,40)
                    diamond3 = Fallthing(money_frame[moneyblit],
