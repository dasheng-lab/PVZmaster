...
class Card:
    ...
    def draw(self):
        ...
        if self.gen_sun:
            ...
            if self.sundiex < 7:
                sun = Fallthing(sun_frame[sun_blit],self.sunrect.x,self.sunrect.y,40,40)
                sun.draw([0,0])
            elif self.sundiex < 14:
                self.place[0] += d(self.sunrect.x, self.sunrect.y, 210, -50)[0]
                self.place[1] += d(self.sunrect.x, self.sunrect.y, 210, -50)[1]
                sun = Fallthing(
                    sun_frame[sun_blit],
                    self.place[0] + self.sunrect.x ,
                    self.place[1] + self.sunrect.y ,40,40)
                sun.draw([0,0])
    ...
    def draw(self, camera, style=0):
        ...
        if self.kind == 1:
            ...
            if self.sundiex < 7:
                ...
                self.place[0] += d(self.rect.x, self.rect.y, 210, -50)[0]
                self.place[1] += d(self.rect.x, self.rect.y, 210, -50)[1]
                sun = Fallthing(
                    sun_frame[sun_blit],
