...
obstacle6 = Obstacle(-800, 200, 200, 700)
...
# obstacle_list0.append(obstacle6)
...
obstacle_list2 = []
obstacle26 = Obstacle(-200, 0, 200, 700)
obstacle27 = Obstacle(1000, 0, 200, 700)
obstacle28 = Obstacle(0, 0, 1000, 150)
obstacle29 = Obstacle(0, 700, 1000, 220)
obstacle30 = Obstacle(500, 600, 500, 100)

obstacle_list2.append(obstacle26)
obstacle_list2.append(obstacle27)
obstacle_list2.append(obstacle28)
obstacle_list2.append(obstacle29)
obstacle_list2.append(obstacle30)
obstacl_class = [obstacle_list0, obstacle_list1, obstacle_list2]
