            ...
            if self.style == 10 and not self.Pause:  # 商店
                    ...
                    if self.goods == 0:
                        ...
                        if player_money.money >= 100:
                            ...
                            if self.wincount < 200:
                                pass
                            elif self.wincount >= 200 and self.wincount < 250:
                                player.beat += 3
                                if not self.cheat:
                                    player.story[3] = player.beat
                            elif self.wincount >= 250 and self.wincount < 300:
                                if player.shoot_speed > 30:
                                ...
                                if not self.cheat:
                                    player.story[4] = player.shoot_speed
                            elif self.wincount >= 300 and self.wincount < 350:
                                player.hp += 50
                                player.besthp += 50
                                if not self.cheat:
                                    player.story[1] = player.hp
                                    player.story[2] = player.besthp
                            elif self.wincount >= 350 and self.wincount < 400:
                                player.speed += 0.25
                                player.speed = round(player.speed, 2)
                                if not self.cheat:
                                    player.story[0] = player.speed
                            elif self.wincount >= 400 and self.wincount < 500:
                                player_money.add_money(50)
                            elif self.wincount >= 500 and self.wincount < 700:
                                player_money.add_money(100)
                            elif self.wincount >= 700 and self.wincount < 800:
                                player_money.add_money(120)
                            elif self.wincount >= 800 and self.wincount < 860:
                                player_money.add_money(150)
                            elif self.wincount >= 860 and self.wincount < 900:
                                player_money.add_money(200)
                            elif self.wincount >= 900 and self.wincount < 950:
                                player_money.add_money(80)
                            elif self.wincount >= 950 and self.wincount < 980:
                                emg.gen_new_zombie(random.randint(200, 600), -800)
                            elif self.wincount >= 980 and self.wincount < 990:
                                emg.gen_new_roadblock_zombie(
                                    random.randint(200, 600), -800
                                )
                            elif self.wincount >= 990 and self.wincount < 995:
                                emg.gen_new_bucket_zombie(
                                    random.randint(200, 600), -800
                                )
                            elif self.wincount >= 995 and self.wincount < 998:
                                emg.gen_new_rugby_zombie(random.randint(200, 600), -800)
                            elif self.wincount >= 998 and self.wincount < 999:
                                emg.gen_new_paper_zombie(random.randint(200, 600), -800)
                            elif self.wincount >= 999:
                ...
                if self.buy > 0:
                    if self.goods == 0:
                        ...
                        text = font1.render(
                            f"现攻速为{round((80/player.shoot_speed)*100,2)}%",
                            True,
                            (255, 255, 127),
                        )
                        screen.blit(text, (405, 350))
                        ...
                        elif self.wincount < 250:
                            text = font1.render(
                                f"伤害提升！现伤害为{player.beat}",
                                True,
                                (255, 255, 127),
                            )
                        elif self.wincount < 300:
                            text = font1.render(
                                f"攻速提升！现攻速为{round((80/player.shoot_speed)*100,2)}%",
                                True,
                                (255, 255, 127),
                            )
                        elif self.wincount < 350:
                            text = font1.render(
                                f"血量提升！现最大血量为{player.besthp}",
                                True,
                                (255, 255, 127),
                            )
                        elif self.wincount < 400:
                            text = font1.render(
                                f"速度提升！现速度为{player.speed}",
                                True,
                                (255, 255, 127),
                            )
                        elif self.wincount < 500:
                            text = font1.render(
                                f"恭喜你获得了50块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 700:
                            text = font1.render(
                                f"恭喜你获得了100块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 800:
                            text = font1.render(
                                f"恭喜你获得了120块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 860:
                            text = font1.render(
                                f"恭喜你获得了150块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 900:
                            text = font1.render(
                                f"恭喜你获得了200块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 950:
                            text = font1.render(
                                f"恭喜你获得了80块钱", True, (255, 255, 127)
                            )
                        elif self.wincount < 980:
                            text = font1.render(
                                f"恭喜你获得了1个僵尸！", True, (255, 255, 127)
                            )
                        elif self.wincount < 990:
                            text = font1.render(
                                f"恭喜你获得了1个路障僵尸！", True, (255, 255, 127)
                            )
                        elif self.wincount < 995:
                            text = font1.render(
                                f"恭喜你获得了1个铁桶僵尸！", True, (255, 255, 127)
                            )
                        elif self.wincount < 998:
                            text = font1.render(
                                f"恭喜你获得了1个橄榄球僵尸！", True, (255, 255, 127)
                            )
                        elif self.wincount < 999:
                            text = font1.render(
                                f"恭喜你获得了1个报纸僵尸！", True, (255, 255, 127)
                            )
                        else:
                            text = font1.render(
                                f"感谢您中了万元大奖！欧皇转世！", True, (255, 255, 127)
                            )
                        screen.blit(text, (405, 350))
                        self.buy -= 1
                if self.status > 0:
            ...
            if self.style == 2 or self.style == 6 or self.style == 7 or self.style == 8:
                ...
                for zombie in emg.zombie_list:
                    if zombie.style != 10 and not (
                        ...
                        zombie.move()
                    zombie.is_fall()
                    if zombie.is_end() and self.style != 7:
                        global end_zombie
                        end_zombie = zombie
                        self.post(
                            Event(
