...
hardness_image = pygame.image.load("images/难度选择.png")
hardness_image = pygame.transform.scale(hardness_image, (500, 600))
picture_list.append(hardness_image)
shop_image = pygame.image.load("images/购买.png")
shop_image = pygame.transform.scale(shop_image, (400, 320))
picture_list.append(shop_image)
help_image = pygame.image.load("images/帮助.png")
help_image = pygame.transform.scale(help_image, (1000, 700))
picture_list.append(help_image)
...
sun_frame = []
for i in range(1, 8):
    picture = pygame.image.load(f"images/sun/图层-{i}.png").convert_alpha()
    sun_frame.append(picture)
...
flag_frame = []
for i in range(1, 13):
    picture = pygame.image.load(f"images/旗帜僵尸/旗帜僵尸图层-{i}.png").convert_alpha()
    flag_frame.append(picture)
flagcold_frame = []
for picture in flag_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    flagcold_frame.append(picture2)
flag_frame0 = [flag_frame, flagcold_frame]

flageat_frame = []
for i in range(1, 12):
    picture = pygame.image.load(
        f"images/旗帜僵尸啃食/旗帜僵尸啃食图层-{i}.png"
    ).convert_alpha()
    flageat_frame.append(picture)
flageatcold_frame = []
for picture in flageat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    flageatcold_frame.append(picture2)
flageat_frame0 = [flageat_frame, flageatcold_frame]

flagnohead_frame = []
for i in range(1, 13):
    picture = pygame.image.load(
        f"images/旗帜僵尸无头/旗帜僵尸无头图层-{i}.png"
    ).convert_alpha()
    flagnohead_frame.append(picture)
flagnoheadcold_frame = []
for picture in flagnohead_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    flagnoheadcold_frame.append(picture2)
flagnohead_frame0 = [flagnohead_frame, flagnoheadcold_frame]

flagnoheadeat_frame = []
for i in range(1, 12):
    picture = pygame.image.load(
        f"images/旗帜僵尸无头啃食/旗帜僵尸无头啃食图层-{i}.png"
    ).convert_alpha()
    flagnoheadeat_frame.append(picture)
flagnoheadeatcold_frame = []
for picture in flagnoheadeat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    flagnoheadeatcold_frame.append(picture2)
flagnoheadeat_frame0 = [flagnoheadeat_frame, flagnoheadeatcold_frame]

erye_frame = []
for i in range(1, 19):
    picture = pygame.image.load(f"images/二爷/二爷图层-{i}.png").convert_alpha()
    erye_frame.append(picture)
eryecold_frame = []
for picture in erye_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryecold_frame.append(picture2)
erye_frame0 = [erye_frame, eryecold_frame]

eryeeat_frame = []
for i in range(1, 9):
    picture = pygame.image.load(f"images/二爷啃食/二爷啃食图层-{i}.png").convert_alpha()
    eryeeat_frame.append(picture)
eryeeatcold_frame = []
for picture in eryeeat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryeeatcold_frame.append(picture2)
eryeeat_frame0 = [eryeeat_frame, eryeeatcold_frame]

eryelosepaper_frame = []
for i in range(1, 12):
    picture = pygame.image.load(f"images/掉报纸/掉报纸图层-{i}.png").convert_alpha()
    eryelosepaper_frame.append(picture)
eryelosepapercold_frame = []
for picture in eryelosepaper_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryelosepapercold_frame.append(picture2)
eryelosepaper_frame0 = [eryelosepaper_frame, eryelosepapercold_frame]

eryeangry_frame = []
for i in range(1, 15):
    picture = pygame.image.load(f"images/生气/生气图层-{i}.png").convert_alpha()
    eryeangry_frame.append(picture)
eryeangrycold_frame = []
for picture in eryeangry_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryeangrycold_frame.append(picture2)
eryeangry_frame0 = [eryeangry_frame, eryeangrycold_frame]

eryeangryeat_frame = []
for i in range(1, 8):
    picture = pygame.image.load(f"images/生气啃食/生气啃食图层-{i}.png").convert_alpha()
    eryeangryeat_frame.append(picture)
eryeangryeatcold_frame = []
for picture in eryeangryeat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryeangryeatcold_frame.append(picture2)
eryeangryeat_frame0 = [eryeangryeat_frame, eryeangryeatcold_frame]

eryenohead_frame = []
for i in range(1, 17):
    picture = pygame.image.load(f"images/二爷无头/二爷无头图层-{i}.png").convert_alpha()
    eryenohead_frame.append(picture)
eryenoheadcold_frame = []
for picture in eryenohead_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryenoheadcold_frame.append(picture2)
eryenohead_frame0 = [eryenohead_frame, eryenoheadcold_frame]

eryenoheadeat_frame = []
for i in range(1, 8):
    picture = pygame.image.load(
        f"images/二爷无头啃食/二爷无头啃食图层-{i}.png"
    ).convert_alpha()
    eryenoheadeat_frame.append(picture)
eryenoheadeatcold_frame = []
for picture in eryenoheadeat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryenoheadeatcold_frame.append(picture2)
eryenoheadeat_frame0 = [eryenoheadeat_frame, eryenoheadeatcold_frame]

eryefall_frame = []
for i in range(1, 12):
    picture = pygame.image.load(f"images/二爷死/二爷死图层-{i}.png").convert_alpha()
    eryefall_frame.append(picture)
eryefallcold_frame = []
for picture in eryenoheadeat_frame:
    picture1 = copy.copy(picture)
    picture2 = changecolor(picture1, 0.8, 0.8, 2)
    eryefallcold_frame.append(picture2)
eryefall_frame0 = [eryefall_frame, eryefallcold_frame]
...
text4 = font.render("", True, (127, 255, 127))
